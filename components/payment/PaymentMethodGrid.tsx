...
const PAYMENT_METHODS: readonly PaymentMethod[] = [
  ...
  // ==========================================================================
  // MEDICAL AID PROVIDERS - COMPLETE ZIMBABWE LIST (NO DUPLICATES)
  // ==========================================================================
  {
    id: 'cimas',
    code: 'CIM',
    ...
    providerId: 'cimas',
    providerCode: 'CIM',
    description: 'Cimas Medical Aid Society'
  },
  {
    id: 'first_mutual',
    code: 'FMH',
  ...
  },
  {
    ...
    providerId: 'psmas',
    providerCode: 'PSM',
    description: 'Public Service Medical Aid Society'
  },
  {
    id: 'liberty',
    code: 'LIB',
    ...
    providerId: 'liberty',
    providerCode: 'LIB',
    description: 'Liberty Health Medical Aid'
  },
  {
    id: 'alliance',
    code: 'ALL',
  ...
  },
  {
    ...
    providerId: 'altfin',
    providerCode: 'ALT',
    description: 'Altfin Health Fund'
  },
  {
    id: 'bonvie',
    code: 'BON',
    ...
    providerId: 'bonvie',
    providerCode: 'BON',
    description: 'BonVie Medical Aid'
  },
  {
    id: 'cellmed',
    code: 'CEL',
    ...
    providerId: 'cellmed',
    providerCode: 'CEL',
    description: 'Cellmed Health Fund'
  },
  {
    id: 'corporate_24',
    code: 'C24',
    ...
    providerCode: 'C24',
    description: 'Corporate 24 Medical Aid'
  },
  {
    id: 'eternal_peace',
    code: 'EPH',
    ...
    providerCode: 'EPH',
    description: 'Eternal Peace Health'
  },
  {
    id: 'fbc',
    code: 'FBC',
  ...
  },
  {
    ...
    providerId: 'flimas',
    providerCode: 'FLI',
    description: 'Flimas Medical Aid'
  },
  {
    ...
    providerCode: 'GEN',
    description: 'Generation Health Medical Aid'
  },
  {
    id: 'grainmed',
    code: 'GRN',
    ...
    providerId: 'grainmed',
    providerCode: 'GRN',
    description: 'Grainmed Medical Aid'
  },
  {
    id: 'healthmed',
    code: 'HLT',
    ...
    providerCode: 'HLT',
    description: 'Healthmed Medical Aid'
  },
  {
    id: 'heritage',
    code: 'HER',
    ...
    providerId: 'heritage',
    providerCode: 'HER',
    description: 'Heritage Medical Aid'
  },
  {
    id: 'hmmas',
    code: 'HMM',
  ...
  },
  {
    ...
    providerId: 'maisha',
    providerCode: 'MAI',
    description: 'Maisha Medical Aid'
  },
  {
    id: 'masca',
    code: 'MAS',
  ...
  },
  {
    ...
    providerId: 'minerva',
    providerCode: 'MIN',
    description: 'Minerva Medical Aid'
  },
  {
    id: 'northern',
    code: 'NOR',
    ...
    providerId: 'northern',
    providerCode: 'NOR',
    description: 'Northern Medical Aid'
  },
  {
    id: 'oakfin',
    code: 'OAK',
    ...
    providerId: 'oakfin',
    providerCode: 'OAK',
    description: 'Oakfin Medical Aid'
  },
  {
    id: 'old_mutual',
    code: 'OMH',
  ...
  },
  {
    ...
    providerCode: 'PRO',
    description: 'ProHealth Medical Aid'
  },
  {
    id: 'varichem',
    code: 'VAR',
    ...
    providerId: 'varichem',
    providerCode: 'VAR',
    description: 'Varichem Medical Aid'
  },
  {
    id: 'emf',
    code: 'EMF',
...
export default function PaymentMethodGrid({
  ...
  const handleMethodSelect = useCallback((method: PaymentMethod) => {
    ...
    if (onCurrencyChange && method.currency !== transactionCurrency) {
      onCurrencyChange(method.currency)
    }
  ...
  const renderMethodCard = (method: PaymentMethod) => {
    ...
    return (
      <button
        ...
        `}
        disabled={disabled}
        aria-label={`${method.name} - ${method.currency} - ${getProcessingTimeLabel(method.processingTime)}`}
